...
public partial class guestbook_index : System.Web.UI.Page
{
    DAL dl = new DAL();
    ...
    public void bind()
    {
        OleDbCommand cmd = new OleDbCommand("select count(id) from guestbook where flag='是'", conn);
        conn.Open();
    ...
    public void bind1()
    {
        OleDbDataAdapter oda = new OleDbDataAdapter("select * from guestbook where flag='是' order by id desc", conn);
